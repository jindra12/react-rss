export const apiResults: { [index: string]: string } = {
    ['http://static.userland.com/gems/backend/rssTwoExample2.xml']: `<?xml version="1.0"?>
    ...
    <rss version="2.0" xmlns:blogChannel="http://backend.userland.com/blogChannelModule">
        <channel>
            ...
            <ttl>40</ttl>
            <newProperty>New message!</newProperty>
            <item>
